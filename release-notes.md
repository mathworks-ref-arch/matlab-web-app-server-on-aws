...
### R2026b
- You can now deploy MATLAB Web App Server R2026b using the Amazon Web Services reference architecture.
- The template now deploys an Application Load Balancer (ALB) that routes traffic to MATLAB Web App Server, admin portal (on Linux servers), and other microservices.
