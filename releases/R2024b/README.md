...
|---------|---------| ------------ | ----------------- |
| R2024b | <a href="https://us-east-1.console.aws.amazon.com/cloudformation/home?region=us-east-1#/stacks/quickcreate?templateURL=https://mb-webapps-template.s3.us-east-2.amazonaws.com/WebAppServer_new.yml" target="_blank">     <img src="https://s3.amazonaws.com/cloudformation-examples/cloudformation-launch-stack.png"/> </a> | <a  href ="https://us-east-2.console.aws.amazon.com/s3/object/mb-webapps-template?region=us-east-2&bucketType=general&prefix=WebAppServer_existing.yml"  target ="_blank" >      <img  src ="https://s3.amazonaws.com/cloudformation-examples/cloudformation-launch-stack.png" /> </a> | Windows Server 2022 or Ubuntu 22.04 VM |
...
|---------|---------------|-------------------|
| R2024b | <a  href ="https://us-east-2.console.aws.amazon.com/s3/object/mb-webapps-template?region=us-east-2&bucketType=general&prefix=WebAppServer_existing.yml"  target ="_blank" >      <img  src ="https://s3.amazonaws.com/cloudformation-examples/cloudformation-launch-stack.png" />  </a> | Windows Server 2022 or Ubuntu 22.04 VM |
